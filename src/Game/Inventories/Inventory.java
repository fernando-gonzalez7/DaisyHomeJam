...
public class Inventory {
    ...
    private void renderItems(Graphics g) {
        ...
        if (inventoryItems.size() == 1) {
            ...
            g.drawImage(inventoryItems.get(8).getTexture(), 208, 85, inventoryItems.get(8).getWidth(), inventoryItems.get(8).getHeight(), null);
            g.drawString(String.valueOf(inventoryItems.get(8).getCount()), 208+33,85+35);
